      ...
      <Card className="w-full max-w-[400px] p-10">
        ...
        <CardContent className="p-0">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <a href="#" className="block text-right text-[#6c47ff] text-xs mb-5 no-underline hover:underline">
              Forgot Password?
            </a>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <label htmlFor="agree" className="text-muted-foreground text-xs">
                I agree to the{' '}
                <a href="#" className="text-[#6c47ff] no-underline hover:underline">Terms of Service</a>
                {' '}and{' '}
                <a href="#" className="text-[#6c47ff] no-underline hover:underline">Privacy Policy</a>
              </label>
            </div>
          ...
          <p className="text-center text-muted-foreground text-sm">
            ...
            <Link to="/register" className="text-[#6c47ff] no-underline hover:underline">Register</Link>
          </p>
        </CardContent>
      </Card>
    </div>
